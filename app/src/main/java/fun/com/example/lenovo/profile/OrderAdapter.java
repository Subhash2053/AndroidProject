...
class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.ProductViewHolder> {
    ...
    public void onBindViewHolder(final ProductViewHolder holder, int position) {
        ...
        holder.tvqty.setText("QTY:"+product.qty);
    ...
    public static class ProductViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView tvPrice,tvqty;


        public ProductViewHolder(View itemView) {
            super(itemView);
            cvProduct = (CardView)itemView.findViewById(R.id.cvorder);
            ivImageUrl = (ImageView)itemView.findViewById(R.id.imageView);
            tvName = (TextView)itemView.findViewById(R.id.name);
            tvPrice = (TextView)itemView.findViewById(R.id.price);
            tvqty=(TextView)itemView.findViewById(R.id.quantity);
